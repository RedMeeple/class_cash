...
class AwardsControllerTest < ActionController::TestCase
  ...
  test "should create award" do
    assert_difference('Award.count') do
      post :create, award: { award_type_id: @award.award_type_id, payment: @award.payment, reason: @award.reason, student_id: @award.student_id }
    end
  ...
  test "should update award" do
    patch :update, id: @award, award: { award_type_id: @award.award_type_id, payment: @award.payment, reason: @award.reason, student_id: @award.student_id }
    assert_redirected_to award_path(assigns(:award))
  end
